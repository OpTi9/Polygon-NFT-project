    ...
    <s.Screen>
      ...
      >
              ...
              <>
                ...
                <s.Container ai={"center"} jc={"center"} fd={"row"}>
                  ...
                  <StyledLinkButton
                      onClick={(e) => {
                        window.open(
                            "https://opensea.io/collection/coronft",
                            "_blank"
                        );
                      }}
                  >
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          ...
          >
            Please connect using the correct address and make sure you are connected to the right network (
